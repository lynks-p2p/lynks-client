...
import { getPeerLatency, loadActivityPattern, createActivityPatternFile, trackActivityPattern, calculateHostAvailability, calculateMatching } from './app/utils/peer';
...
loadActivityPattern((activity)=>{
  calculateHostScore('10.40.60.62',activity, (score)=>{
      console.log(score);
  });
});
